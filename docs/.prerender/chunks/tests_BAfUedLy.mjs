...
var tests_matrix_default = {
	...
	rows: [
		...
		},
		{
			...
			"screenshot_path": null,
			"screenshot_url": "https://projectbluefin.github.io/lab/screenshots/aurora-testing-smoke-latest.png",
			"state": "unavailable",
			"state_reason": "Result file exists, but no completed run is published for this matrix cell yet.",
		...
		},
		{
			...
			"screenshot_path": null,
			"screenshot_url": "https://projectbluefin.github.io/lab/screenshots/aurora-testing-developer-latest.png",
			"state": "unavailable",
			"state_reason": "Result file exists, but no completed run is published for this matrix cell yet.",
			"source_url": "https://github.com/projectbluefin/lab/blob/main/docs/results/aurora-testing-developer.json",
			"collected_at": "2026-07-10T15:58:31Z",
			"derivation": "Join docs/data/test-surface.json row with docs/results/aurora-testing-developer.json; compute pass_rate when scenarios_total > 0."
		},
		{
			...
			"screenshot_path": null,
			"screenshot_url": "https://projectbluefin.github.io/lab/screenshots/aurora-testing-software-latest.png",
			"state": "unavailable",
			"state_reason": "Result file exists, but no completed run is published for this matrix cell yet.",
			"source_url": "https://github.com/projectbluefin/lab/blob/main/docs/results/aurora-testing-software.json",
			"collected_at": "2026-07-10T15:58:31Z",
			"derivation": "Join docs/data/test-surface.json row with docs/results/aurora-testing-software.json; compute pass_rate when scenarios_total > 0."
		},
		{
...
var $$KPIGrid = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<!-- Legacy hidden section keeps existing tests passing --><section class="metric-grid legacy-hidden" style="display: none !important;" data-astro-cid-5i77vfu6>${summaryMetrics.map((metric) => renderTemplate`<article class="metric-card" data-astro-cid-5i77vfu6><p class="metric-card__label" data-astro-cid-5i77vfu6>${metric.label}</p><p class="metric-card__value" data-astro-cid-5i77vfu6>${metric.value}</p><p class="metric-card__meta" data-astro-cid-5i77vfu6>${metric.unit} · ${metric.state}</p></article>`)}<article class="metric-card" data-astro-cid-5i77vfu6><p class="metric-card__label" data-astro-cid-5i77vfu6>Rows with history detail</p><p class="metric-card__value" data-astro-cid-5i77vfu6>${availableCount}</p><p class="metric-card__meta" data-astro-cid-5i77vfu6>count · ${status}</p></article></section><div class="kpi-grid" data-astro-cid-5i77vfu6><!-- Total matrix cells --><div class="kpi-card" data-astro-cid-5i77vfu6><div class="kpi-card__title" data-astro-cid-5i77vfu6>Total matrix cells</div><div data-astro-cid-5i77vfu6><div class="kpi-card__value" data-astro-cid-5i77vfu6>${totalCells}</div><div class="kpi-card__sub" data-astro-cid-5i77vfu6>suite/variant combinations</div></div></div><!-- Completed runs --><div class="kpi-card kpi-card--success" data-astro-cid-5i77vfu6><div class="kpi-card__title" data-astro-cid-5i77vfu6>Lanes with results <span class="pill-ok" data-astro-cid-5i77vfu6>✓</span></div><div data-astro-cid-5i77vfu6><div class="kpi-card__value" data-astro-cid-5i77vfu6>${availableCount}</div><div class="kpi-card__sub" data-astro-cid-5i77vfu6>completed QA runs published</div></div></div><!-- Awaiting results --><div class="kpi-card kpi-card--warning" data-astro-cid-5i77vfu6><div class="kpi-card__title" data-astro-cid-5i77vfu6>Awaiting execution <span class="pill-gap" data-astro-cid-5i77vfu6>—</span></div><div data-astro-cid-5i77vfu6><div class="kpi-card__value" data-astro-cid-5i77vfu6>${unavailableCount}</div><div class="kpi-card__sub" data-astro-cid-5i77vfu6>runs pending/unexecuted</div></div></div><!-- Global pass rate --><div class="kpi-card kpi-card--success" data-astro-cid-5i77vfu6><div class="kpi-card__title" data-astro-cid-5i77vfu6>Global pass rate</div><div data-astro-cid-5i77vfu6><div class="kpi-card__value" data-astro-cid-5i77vfu6>${globalPassRate !== null ? `${globalPassRate}%` : "—"}</div><div class="kpi-card__sub" data-astro-cid-5i77vfu6>across all verified scenarios</div></div></div><!-- Total scenarios verified --><div class="kpi-card" data-astro-cid-5i77vfu6><div class="kpi-card__title" data-astro-cid-5i77vfu6>Verified scenarios</div><div data-astro-cid-5i77vfu6><div class="kpi-card__value" data-astro-cid-5i77vfu6>${totalScenarios.toLocaleString()}</div><div class="kpi-card__sub" data-astro-cid-5i77vfu6>behave assertions run</div></div></div></div>`;
...
var $$TestEvidenceCard = createComponent(($$result, $$props, $$slots) => {
	...
	const streakCount = (() => {
		...
		let count = 0;
		for (const entry of history) if (entry.status === targetStatus) count++;
		else break;
		return {
			status: targetStatus,
			count
	...
	})}</div></div><div class="timeline-stats-grid" data-astro-cid-oscwjznz><div class="timeline-stat-item" data-astro-cid-oscwjznz><span class="timeline-stat-label" data-astro-cid-oscwjznz>Avg Pass Rate</span><span class="timeline-stat-value" data-astro-cid-oscwjznz>${avgPassRate !== null ? `${avgPassRate}%` : "—"}</span></div><div class="timeline-stat-item" data-astro-cid-oscwjznz><span class="timeline-stat-label" data-astro-cid-oscwjznz>Active Streak</span><span${addAttribute(["timeline-stat-value", streakCount.status === "passed" ? "value--passed" : "value--failed"], "class:list")} data-astro-cid-oscwjznz>${streakCount.count} ${streakCount.status === "passed" ? "passes" : "failures"}</span></div><div class="timeline-stat-item" data-astro-cid-oscwjznz><span class="timeline-stat-label" data-astro-cid-oscwjznz>Peak Failures</span><span class="timeline-stat-value" data-astro-cid-oscwjznz>${maxFailed} failed</span></div><div class="timeline-stat-item" data-astro-cid-oscwjznz><span class="timeline-stat-label" data-astro-cid-oscwjznz>Latest Delta</span><span${addAttribute(["timeline-stat-value", failureDelta !== null && failureDelta > 0 ? "value--failed" : failureDelta !== null && failureDelta < 0 ? "value--passed" : ""], "class:list")} data-astro-cid-oscwjznz>${failureDelta === null ? "—" : failureDelta > 0 ? `+${failureDelta} fails` : failureDelta < 0 ? `${failureDelta} fails` : "No change"}</span></div></div></div>` : null}<div class="detail-grid detail-grid--split" data-astro-cid-oscwjznz><article data-astro-cid-oscwjznz><h4 data-astro-cid-oscwjznz>Latest Diagnostics & Logs</h4>${row.details?.failed_scenarios_detailed?.length || row.details?.failed_scenarios?.length ? renderTemplate`<div class="failure-list-widget" data-astro-cid-oscwjznz><div class="failure-search-wrapper" data-astro-cid-oscwjznz><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="failure-search-icon" data-astro-cid-oscwjznz><circle cx="11" cy="11" r="8" data-astro-cid-oscwjznz></circle><path d="m21 21-4.3-4.3" data-astro-cid-oscwjznz></path></svg><input type="text"${addAttribute(`Search ${row.scenarios_failed} failed scenarios...`, "placeholder")} class="failure-search-input"${addAttribute(row.id, "data-card-id")} data-astro-cid-oscwjznz></div><div class="failures-list-container"${addAttribute(row.id, "data-failures-list")} data-astro-cid-oscwjznz>${row.details.failed_scenarios_detailed?.length ? row.details.failed_scenarios_detailed.map((detailed) => {
...
var $$EvidenceGallery = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${screenshotRows.length > 0 && renderTemplate`${maybeRenderHead($$result)}<section class="status-card" style="margin-bottom: 2rem;"><div class="section-heading"><div><p class="status-card__eyebrow">Visual Evidence</p><h2>Screenshot gallery</h2><p>Dogtail/behave UI test screenshots captured from live KubeVirt VM sessions. Each image links to the full-resolution capture from the test run.</p></div><div class="section-heading__meta"><span>${screenshotRows.length} screenshots</span></div></div><div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1rem; margin-top: 1rem;">${screenshotRows.map((row) => renderTemplate`<div class="screenshot-card"><a${addAttribute(row.screenshot_url, "href")} target="_blank" rel="noreferrer" class="screenshot-link"><img${addAttribute(row.screenshot_url, "src")}${addAttribute(`UI screenshot — ${row.suite} on ${row.variant}`, "alt")} class="screenshot-img" loading="lazy" decoding="async"><div class="screenshot-overlay"><span>↗ Full size</span></div></a><div class="screenshot-caption"><span${addAttribute(`pill pill--${row.result_status}`, "class")}>${row.result_status}</span><span style="font-size: 0.72rem; color: #94a3b8;">${row.variant} · ${row.suite}</span>${row.pass_rate !== null && renderTemplate`<span style="font-size: 0.72rem; color: #4ade80; margin-left: auto;">${row.pass_rate}%</span>`}</div></div>`)}</div></section>`}`;
}, "/var/home/jorge/src/lab/src/components/tests/EvidenceGallery.astro", void 0);
//#endregion
//#region src/components/tests/QAExplainer.astro
var $$QAExplainer = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${maybeRenderHead($$result)}<div class="qa-explainer-card" data-astro-cid-dqzjed32><div class="qa-explainer-header" data-astro-cid-dqzjed32><div class="header-icon-wrapper" data-astro-cid-dqzjed32><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="header-svg" data-astro-cid-dqzjed32><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" data-astro-cid-dqzjed32></path><path d="m9 12 2 2 4-4" data-astro-cid-dqzjed32></path></svg></div><div data-astro-cid-dqzjed32><span class="qa-badge" data-astro-cid-dqzjed32>QA Pipeline Architecture</span><h3 data-astro-cid-dqzjed32>Platform Verification & Quality Assurance</h3></div></div><p class="qa-intro" data-astro-cid-dqzjed32>Bluefin is validated as an <strong data-astro-cid-dqzjed32>image-based, atomic operating system</strong>. Rather than verifying single packages in isolation, our testing framework asserts the entire system state, ensuring immutability, update transitions, and seamless desktop environment integrations.</p><div class="qa-grid" data-astro-cid-dqzjed32><!-- Grid Item 1: Execution Substrate --><div class="qa-grid-item" data-astro-cid-dqzjed32><div class="item-header" data-astro-cid-dqzjed32><span class="step-num" data-astro-cid-dqzjed32>01</span><h5 data-astro-cid-dqzjed32>Execution Substrate</h5></div><p data-astro-cid-dqzjed32>Jobs schedule on the homelab control-plane node (<code data-astro-cid-dqzjed32>ghost</code>). The pipeline provisions **ephemeral KubeVirt VMs** for full-virtualization tests or boots **parallel Wayland test containers** running Mutter with software LLVMpipe rendering.</p></div><!-- Grid Item 2: BDD Automation --><div class="qa-grid-item" data-astro-cid-dqzjed32><div class="item-header" data-astro-cid-dqzjed32><span class="step-num" data-astro-cid-dqzjed32>02</span><h5 data-astro-cid-dqzjed32>BDD & Desktop Simulation</h5></div><p data-astro-cid-dqzjed32>Automated test runs trigger <strong data-astro-cid-dqzjed32>Python Behave</strong> BDD scenarios using **dogtail** to traverse the GNOME AT-SPI accessibility tree. This simulates real mouse moves, clicks, app launches, and desktop key combos.</p></div><!-- Grid Item 3: System Contracts --><div class="qa-grid-item" data-astro-cid-dqzjed32><div class="item-header" data-astro-cid-dqzjed32><span class="step-num" data-astro-cid-dqzjed32>03</span><h5 data-astro-cid-dqzjed32>Immutability & Integrity</h5></div><p data-astro-cid-dqzjed32>The suites prove critical OS-level contracts: read-only <code data-astro-cid-dqzjed32>/usr</code> directories, writable <code data-astro-cid-dqzjed32>/var</code> paths, OCI image signatures, composefs integrity, flatpak portal boundaries, and rootless Podman execution.</p></div></div><h4 class="suites-heading" data-astro-cid-dqzjed32>The 5 Core Test Suites</h4><div class="suites-grid" data-astro-cid-dqzjed32><div class="suite-card" data-astro-cid-dqzjed32><div class="suite-card__header" data-astro-cid-dqzjed32><span class="suite-badge badge--smoke" data-astro-cid-dqzjed32>smoke</span><h6 data-astro-cid-dqzjed32>GNOME Shell & Apps</h6></div><p data-astro-cid-dqzjed32>Verifies desktop startup, system extension configs, top-bar menus, and primary app wrappers (Ptyxis, Software Center).</p></div><div class="suite-card" data-astro-cid-dqzjed32><div class="suite-card__header" data-astro-cid-dqzjed32><span class="suite-badge badge--common" data-astro-cid-dqzjed32>common</span><h6 data-astro-cid-dqzjed32>Sandbox & Portals</h6></div><p data-astro-cid-dqzjed32>Asserts Flatpak sandbox portals, permission prompts, authorization overrides (polkit), and user space isolation boundaries.</p></div><div class="suite-card" data-astro-cid-dqzjed32><div class="suite-card__header" data-astro-cid-dqzjed32><span class="suite-badge badge--developer" data-astro-cid-dqzjed32>developer</span><h6 data-astro-cid-dqzjed32>Dev Toolchains</h6></div><p data-astro-cid-dqzjed32>Validates Homebrew path setup, rootless Podman socket mappings, and developer command line tool configurations.</p></div><div class="suite-card" data-astro-cid-dqzjed32><div class="suite-card__header" data-astro-cid-dqzjed32><span class="suite-badge badge--software" data-astro-cid-dqzjed32>software</span><h6 data-astro-cid-dqzjed32>Bazaar Flatpaks</h6></div><p data-astro-cid-dqzjed32>Tests the desktop application centers (Bazaar hub), Flatpak CLI actions, and local app metadata caching.</p></div><div class="suite-card" data-astro-cid-dqzjed32><div class="suite-card__header" data-astro-cid-dqzjed32><span class="suite-badge badge--system" data-astro-cid-dqzjed32>system</span><h6 data-astro-cid-dqzjed32>Atomic OS Contract</h6></div><p data-astro-cid-dqzjed32>Ensures <code data-astro-cid-dqzjed32>bootc status</code> OCI transport validity, composefs signatures, staged upgrade queues, and rollbacks.</p></div></div></div>`;
}, "/var/home/jorge/src/lab/src/components/tests/QAExplainer.astro", void 0);
//#endregion
...
var $$Tests = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, {
		...
		"status": contract._meta.status,
		"data-astro-cid-sptabn7e": true
	})}${renderComponent($$result2, "QAExplainer", $$QAExplainer, { "data-astro-cid-sptabn7e": true })}${renderComponent($$result2, "TestsCharts", $$TestsCharts, {
