...
- **Flatcar DaemonSet in ErrImagePull with `wolfi-base:latest-dev`** — that tag does not exist. The correct tag is `cgr.dev/chainguard/wolfi-base@sha256:02dab76bd852a70556b5b2002195c8a5fdab77d323c433bf6642aab080489795` (`:latest` already has full tooling including nsenter).
